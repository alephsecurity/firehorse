...
t.add_target(name="mido", arch=32, 
                ...
                peekpoke_style=0, 
                saved_lr=0x0803e65b,  saved_lr_addr = 0x8057ee4,
                pbl_base_addr=0x100000,
                pbl_copy_addr=0x8068000,
                page_table_base = 0x200000,
                fh_base_programmer = 0x0210000,
                fh_base_aboot=0x8f900000, fh_scratch_offset=0x4100, fh_saved_regs_offset=0x4000, 
