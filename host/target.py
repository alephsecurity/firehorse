...
class Target:
    ...
    def __init__(self, name, arch, programmer_path, peekpoke_style, saved_lr=0, saved_lr_addr=0,
                 ...
                 basicblocks_db_pbl=None, magic=None, rop=None, uart=0, exe_addr=0,
                 ttbr0_el1=0, pt_levels=1, xmlhunter_part_size=0, rawprogram_xml=None,
                 ufs=False, modem_pbl_base_addr=0, rpm_pbl_base_addr=0, tnsz=0):
    ...
    def do_cmd(self, args):
        ...
        if args[0] == "read_partition":
            if self.rawprogram_xml is None:
                raise NotImplementedError()
